...
# 1.2 Create Log file
logfile = createLog(inBam_dir, bed_dir, outDir, ref, window, cpu, windowAss, ploidy, software, HaploDev, minimumSupport, minimumCoverage)
# 1.3 Read bed file
...
if software == 'otter':
    ...
    os.system("~/.conda/envs/treat/bin/python %s/call_haplotypes.py %s/assembly_trf_phasing.txt.gz %s %s %s %s %s" %(file_path, outDir, outDir, cpu, HaploDev, 'otter', minimumSupport))
